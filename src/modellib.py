...
def keypoint_embedding(x, units): 
    INIT_HE_UNIFORM = keras.initializers.he_uniform
    INIT_GLOROT_UNIFORM = keras.initializers.glorot_uniform
    GELU = keras.activations.gelu
    x = keras.layers.Dense(units, use_bias=False, kernel_initializer=INIT_GLOROT_UNIFORM)(x)
...
def build_model(
    ...
    # embed = keras.layers.Dense(embed_dim)(inputs)
